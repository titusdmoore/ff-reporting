...
export default function Sidebar(props) {
    ...
    const [navigationInfoRead, setNavigationInfoRead] = useState(false);

    const dismissInfoContent = () => {
        setNavigationInfoRead(true);
    }

    return (
        <aside className={className} aria-label="Sidebar">
            <div className="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800 h-full flex flex-col justify-between">
                    ...
                    <div>
                        ...
                        <li>
                            <a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap">Firefighters</span>
                            </a>
                        </li>
                        <li>
                            <Link href="/reports/fire-incident">
                                <div className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <svg className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clipRule="evenodd"></path></svg>
                                    <span className="flex-1 ml-3 whitespace-nowrap">Incident Report</span>
                                </div>
                            </Link>
                        </li>
                    </div>
                ...
                {navigationInfoRead ? ("") : ( 
                    <div id="dropdown-cta" className="p-4 mt-6 bg-blue-50 rounded-lg dark:bg-blue-900" role="alert">
                        <div className="flex items-center mb-3">
                            ...
                            <button type="button" className="ml-auto -mx-1.5 -my-1.5 bg-blue-50 text-blue-900 rounded-lg focus:ring-2 focus:ring-blue-400 p-1 hover:bg-blue-200 inline-flex h-6 w-6 dark:bg-blue-900 dark:text-blue-400 dark:hover:bg-blue-800" aria-label="Close" onClick={dismissInfoContent}>
                        ...
                        <p className="mb-3 text-sm text-blue-900 dark:text-blue-400">
                            Preview the new Incident Reporting System. This is still under development and if you notice any issues, or have any ideas, reach out and let us know.
                        </p>
